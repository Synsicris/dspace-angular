...
?>
  ...
  <?php include("includes/header.inc.php"); echo "\n"; // Header ("SynSICRIS Hilfe") ?>
	 ...
	 <!-- Platzhalter deutsch / englisch für Auswahl anderer Sprache -->
	  ...
	  <n2><strong>Bereiche</strong></n2><br>
  ...
  <?php include("includes/sidenav.inc.php"); echo "\n"; // Seitennavigation ?>
	...
	<main>
  <h1>Hilfe für einzelne Inhalte</h1>
    <p>Auf den folgenden Seiten finden Sie detaillierte Informationen, die Ihnen helfen, Einträge in der jeweiligen Kategorie zu erstellen <!-- sowie zum Import -->.</p>
    <p>Diese inhaltlichen Erläuterungen sind teilweise sehr umfangreich. Sie können die <strong>Suchfunktion</strong> Ihres Browsers nutzen, um den Text gezielt nach Begriffen zu durchsuchen. Ebenso können Sie das Browserfenster der Hilfeseiten und das Browserfenster des Monitoring-Tools <strong>nebeneinander auf Ihrem Bildschirm anordnen</strong>. Wenn Sie nun einen bestimmten Abschnitt des Eintrags ausfüllen, können Sie sich die Detailinformationen zum Abschnitt "danebenlegen".</p> 
    </main>
