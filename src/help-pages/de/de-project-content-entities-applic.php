...
?>
  ...
  <body class="content" id="content-entities-applic">
  ...
  <?php include("includes/header.inc.php"); echo "\n"; // Header ("SynSICRIS Hilfe") ?>
	...
	<?php /* Alte Navigation kann geloescht werden.
	 ...
	 <!-- Platzhalter deutsch / englisch für Auswahl anderer Sprache -->
	  ...
	  <n3><strong>Anwendung_(Möglichkeiten)</strong></n3><br>
  ...
  <?php include("includes/sidenav.inc.php"); echo "\n"; // Seitennavigation ?>
	...
	<main>
      <h1>Anwendung (Möglichkeiten)</h1>

		<article>

		<img src="img/de_project_about_entities_applic_Zusammenhaenge.png"> <!-- ACHTUNG: keine Sonderzeichen in Dateinamen verwenden! -->
