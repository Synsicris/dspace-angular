...
?>
  ...
  <?php include("includes/header.inc.php"); echo "\n"; // Header ("SynSICRIS Hilfe") ?>
	 ...
	 <!-- Platzhalter deutsch / englisch für Auswahl anderer Sprache -->
	  ...
	  <n2><strong>Arbeitsplan</strong></n2><br>
	  <n3><a href="de-project-details-wp-wpabout.php">Hintergrund</a></n3><br> <!-- Datei fehlt -->
	  <n3><a href="de-project-details-wp-wphelp.php">Hilfe</a></n3><br> <!-- Datei fehlt -->
