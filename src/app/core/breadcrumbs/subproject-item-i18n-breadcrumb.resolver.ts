...
import { SubprojectItemI18nBreadcrumbsService } from './subproject-item-i18n-breadcrumbs.service';

/**
 * The class that resolves the BreadcrumbConfig object for a Project
 */
@Injectable()
export class SubprojectItemI18nBreadcrumbResolver implements Resolve<BreadcrumbConfig<string>> {
  constructor(protected breadcrumbService: SubprojectItemI18nBreadcrumbsService, protected dataService: CommunityDataService) {
  }
