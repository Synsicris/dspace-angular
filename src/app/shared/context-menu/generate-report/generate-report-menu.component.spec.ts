...
import { GenerateReportMenuComponent } from './generate-report-menu.component';

describe('GenerateReportMenuComponent', () => {
  let component: GenerateReportMenuComponent;
  let componentAsAny: any;
  let fixture: ComponentFixture<GenerateReportMenuComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(GenerateReportMenuComponent);
  ...
  describe('when the user is collection admin', () => {
    ...
    it('should invoke script process', () => {
      ...
      scheduler.schedule(() => component.generateReport());
      scheduler.flush();
