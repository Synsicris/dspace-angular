...
const contextMenuEntriesMap: Map<DSpaceObjectType|string, ContextMenuEntryRenderOptions[]> = new Map();
 ...
 */
export function rendersContextMenuEntriesForType(type: DSpaceObjectType|string, isStandAlone: boolean = false) {
